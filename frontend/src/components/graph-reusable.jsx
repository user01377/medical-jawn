...
const GET_SYS_DATA = "http://127.0.0.1:8000/get-patient-sys-data/14903219353641";
const PREDICT_SYS_DATA = "http://127.0.0.1:8000/predict-patient-sys-data/14903219353641";
...
export default function SystolicGraph() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        // --- Fetch real data ---
        const resReal = await fetch(GET_SYS_DATA);
